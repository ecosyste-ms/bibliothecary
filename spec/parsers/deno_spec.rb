...
describe Bibliothecary::Parsers::Deno do
  ...
  it "parses dependencies from deno.lock" do
    expect(described_class.analyse_contents("deno.lock", load_fixture("deno.lock"))).to eq({
      ...
      project_name: nil,
      dependencies: [
        Bibliothecary::Dependency.new(platform: "deno", name: "@std/fs", requirement: "1.0.3", type: "runtime", source: "deno.lock"),
        Bibliothecary::Dependency.new(platform: "deno", name: "@std/path", requirement: "1.0.6", type: "runtime", source: "deno.lock"),
        Bibliothecary::Dependency.new(platform: "deno", name: "chalk", requirement: "5.3.0", type: "runtime", source: "deno.lock"),
        Bibliothecary::Dependency.new(platform: "deno", name: "lodash", requirement: "4.17.21", type: "runtime", source: "deno.lock"),
      ],
      kind: "lockfile",
      success: true,
    })
